...
public class UserServiceTest {
    ...
    public void insertUser(Map<String, String> config) throws JSONException {
        String body="{\"Header\":{},\"Params\":{\"UserName\":\"sazzad"+(new Date().getTime())+"@gmail.com\",\"Password\":\"12345678\",\"FirstName\":\"abc\",\"LastName\":\"bcd\",\"EmailAddress\":\"sazzad"+(new Date().getTime())+"@gmail.com\"}}";
